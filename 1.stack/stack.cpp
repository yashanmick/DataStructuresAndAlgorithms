...
public:
    ...
    {
        top = -1;
        // assigning all the elements as 0, when the costructer called
        for (int i = 0; i < 5; i++)
        {
            arr[i] = 0;
        }
...
int main()
{
    ...
    do
    {
        ...
        case 5:
            ...
            cin >> position;
            cout << "Peek function called: value at postion" << position << " is " << s1.peek(position) << endl;
            break;
        case 6:
        ...
        case 8:
            ...
            break;
        case 9:
            system("cls"); //inbuild function to clear screen
            break;
        default:
